...
- **Permissions helper**: The sidebar now shows the current permission status and a “Grant Full Disk Access” shortcut button that opens the macOS Privacy settings for protected folders.
